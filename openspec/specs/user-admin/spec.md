...
Admin pages for managing users, roles, and the role-permission matrix, each gated by the corresponding `admin.*` policy. Pages are plain Razor views; visual polish is deferred to the Stitch redesign.
...
- Admin pages are plain Razor; visual polish is deferred to the Stitch redesign.
